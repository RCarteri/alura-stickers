...
public class Filme {
    ...
    public String toString() {
        ...
        sb.append(Filme.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Filme) == false) {
            return false;
        }
        Filme rhs = ((Filme) other);
